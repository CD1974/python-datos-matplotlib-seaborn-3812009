...
ax.plot(df_ventas['annio'], df_ventas['venta_cromos_101'], label="Cromos 101", linestyle=':', color="orange")
ax.plot(df_ventas['annio'], df_ventas['venta_cromos_102'], label="Cromos 102", linestyle='-.', color="grey")
